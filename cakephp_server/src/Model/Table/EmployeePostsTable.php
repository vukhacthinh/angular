 ...
 */
class EmployeePostsTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config): void
    {
        ...
        $this->setTable('employee_posts');
        $this->setDisplayField('id');
        $this->setPrimaryKey('id');

        $this->hasMany('DetailPost')
             ->setForeignKey('employee_post_id')
             ->setClassName('EmployeePostComments');
    }
